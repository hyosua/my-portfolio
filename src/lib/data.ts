...
export const skills = {
  ...
  backendDevelopment: ["Node.js", "Express", "Python", "PHP"],
  databaseAndStorage: ["PostgreSQL", "MySQL", "SQLite", "MongoDB", "Redis"],
  cloudAndDevOps: ["Docker", "Vercel", "CI/CD", "Git", "Linux", "Cloudinary"],
  toolsAndServices: ["Vite", "Framer Motion"],
};
